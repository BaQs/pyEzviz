...
class EzvizClient(object):
    ...
    def _login(self, apiDomain=EU_API_DOMAIN):
        ...
        try:
            ...
            if json_result['retcode'] == "1001":
                ...
                req = self._session.get("https://" + EU_API_DOMAIN + "." + API_BASE_TLD + "/check_plugin.jsp",
                                        timeout=self._timeout)
    ...
    def _get_alarminfo(self, serial, alarmType=-1, pageStart=0, pageSize=1, max_retries=0):
        ...
        #session is wrong, need to relogin
           ...
           return self._get_alarminfo(max_retries+1)
    ...
    def data_report(self, serial, enable=1, max_retries=0):
        ...
        try:
            req = self._session.post(API_BASE_URI + API_ENDPOINT_SET_DEFENCE,
